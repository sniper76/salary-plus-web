...
class PostState extends BaseState implements PagingState {
  ...
  const PostState({
    this.boardGroup = BoardGroupType.analysis,
  ...
  PostState copyWith({
    ...
    return PostState(
      ...
      selectedSimpleStock: crearSimpleStock ? null : selectedSimpleStock ?? this.selectedSimpleStock,
