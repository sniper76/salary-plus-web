...
class SideMenuRoute {
  ...
  final IconData? icon;
  final String? path;
  final List<SideMenuRoute>? subItems;
...
class ActSideMenuBar extends StatefulWidget {
  final User? user;
  ...
  @override
  State<ActSideMenuBar> createState() => _ActSideMenuBarState();
}

class _ActSideMenuBarState extends State<ActSideMenuBar> {
  ...
  List<Widget> _buildMenuItems({required List<SideMenuRoute> routes, double gap = 50}) {
