...
class _$DataResponseImpl<T> implements _DataResponse<T> {
  const _$DataResponseImpl({this.paging, this.data});
  ...
  @override
  String toString() {
    return 'DataResponse<$T>(paging: $paging, data: $data)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, paging, const DeepCollectionEquality().hash(data));
...
abstract class _DataResponse<T> implements DataResponse<T> {
  const factory _DataResponse({final Paging? paging, final T? data}) =
